...
export function OrdersTable() {
  ...
  return (
    <Card className="bg-card border-border">
      <CardHeader>
        <CardTitle className="text-card-foreground">Gestion des Commandes</CardTitle>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/50">
                <TableHead className="text-card-foreground">ID Commande</TableHead>
                <TableHead className="text-card-foreground">Client</TableHead>
                <TableHead className="text-card-foreground">Téléphone</TableHead>
                ...
                <TableHead className="text-card-foreground">Livraison</TableHead>
            ...
            <TableBody>
              {filteredOrders.map((order) => (
                <TableRow key={order.id} className="hover:bg-muted/30">
                  ...
                  <TableCell className="text-card-foreground">{order.clientName}</TableCell>
                  <TableCell className="text-card-foreground">{order.phone}</TableCell>
                  <TableCell className="text-card-foreground max-w-[200px] truncate" title={order.address}>
                    {order.address}
                  </TableCell>
                  <TableCell className="text-card-foreground">
                    <Badge variant={order.zone === "Rabat" ? "default" : "secondary"}>{order.zone}</Badge>
                  </TableCell>
                  <TableCell className="text-card-foreground">{order.quantity}</TableCell>
                  <TableCell className="text-card-foreground">{order.size}</TableCell>
                  <TableCell className="text-card-foreground">
                  ...
                  <TableCell className="text-card-foreground font-medium">{order.price} MAD</TableCell>
                  <TableCell>
